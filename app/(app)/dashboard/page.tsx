...
export const metadata = { title: 'Dashboard — Project Vintage' }
...
export default function DashboardPage() {
  return (
    <main style={{ maxWidth: 640, margin: '80px auto', padding: '0 24px' }}>
      ...
      >
        Your portfolio at a glance — live valuations, market moves, and garage
        activity — coming in the next build.
      </p>
